...
{%
	...
	{% start of glossary
		...
		\setlength{\glsdescwidth}{.9\linewidth-0.13\linewidth-0.15\linewidth-4\tabcolsep}%
		% If you only have short descriptions, use 0.20 (for example) instead of 0.13 and "l" instead of "c" for Abkürzung/Abbrevation
		% Start the tabular environment
		\begin{longtable}{>{\RaggedRight\hspace{0pt}}p{0.13\linewidth}>{\RaggedRight\hspace{0pt}}p{\glsdescwidth}>{\Centering}p{0.15\linewidth}}
			\toprule
			\ifdeutsch
			\multicolumn{1}{c}{\textbf{Abkürzung}} &
			\multicolumn{1}{@{}c}{\textbf{Bedeutung}} &
			\multicolumn{1}{@{}c}{\textbf{Erstes Vorkommen}}\\%
			\else
			\multicolumn{1}{c}{\textbf{Abbreviation}} &
			\multicolumn{1}{@{}c}{\textbf{Meaning}} &
			\multicolumn{1}{@{}c}{\textbf{First occurrence}}\\%
			\fi
			\midrule\endfirsthead
			\caption*{\ifdeutsch(fortsetzung)\else(continued)\fi}\\
			\toprule
			\ifdeutsch
			\multicolumn{1}{c}{\textbf{Abkürzung}} &
			\multicolumn{1}{@{}c}{\textbf{Bedeutung}} &

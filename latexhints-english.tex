...
\section{UML diagramme using PlantUML}
...
{data/data.csv}
\caption{Tabelle direclty generated from the values of a csf file.}
\end{table}
}{}
...
In case \LuaLaTeX{} is used as compiler, there is no ligature at \enquote{f"|l} in the word \enquote{dwarflike} (in contrast to \enquote{fl} at \enquote{workflow}).

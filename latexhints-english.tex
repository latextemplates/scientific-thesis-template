...
This rule is important for the usage of version controll systems.
...
\label{sec:mf}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
Equations $f(x)=x$ inside the text can be provided. A list with all available mathematical symbols is provided here\footnote{\url{http://www.ctan.org/tex-archive/info/symbols/comprehensive/symbols-a4.pdf}}.
As example the set of natural numbers is given by $\mathbb{N}$.
For the documentation of editing mathemacitcal formulas read the package \texttt{amsmath}\footnote{\url{ftp://ftp.ams.org/pub/tex/doc/amsmath/}}.
...
\section{Weitere Illustrationen}
\Cref{fig:AnhangsChor,fig:AnhangsChor2} zeigen zwei Choreographien, die den Sachverhalt weiter erlÃ¤utern sollen.
...
\IfFileExists{pgfplots.sty}{
  ...
  %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
  The package pdfplots provides plotting of functions directly in \LaTeX~like with matlab or gnuplot.
  \begin{figure}[h]
    \begin{center}
      \begin{tikzpicture}
        \begin{axis}[xlabel=$x$,
